...
class Deadlock implements Runnable {
    ...
    private void smokerMatches() {
        try {
            while (true) {
                paper.acquire();
                System.out.println("Match smoker acquired paper");
                tobacco.acquire();
                System.out.println("Match smoker acquired tobacco");
    ...
    private void smokerPaper() {
        try {
            while (true) {
                matches.acquire();
                System.out.println("Paper smoker acquired matches");
                tobacco.acquire();
                System.out.println("Paper smoker acquired tobacco");
    ...
    private void smokerTobacco() {
        try {
            while (true) {
                matches.acquire();
                System.out.println("Tobacco smoker acquired matches");
                paper.acquire();
                System.out.println("Tobacco smoker acquired paper");
